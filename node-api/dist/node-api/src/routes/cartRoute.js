...
passport_2.default(passport_1.default); // for passport
const cartRoute = express_1.default.Router();
exports.cartRoute = cartRoute;
cartRoute.use(express_1.default.urlencoded({ extended: false })); // Both used to make POST see my request, otherwise it comes as undefined
